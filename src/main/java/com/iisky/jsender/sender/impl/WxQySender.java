...
import com.iisky.jsender.sdk.weixin.qy.WxQyApi;
 ...
 * @date 2021-09-01
 */
public class WxQySender implements ISender<WxQyCfg> {

    @Override
    public Resp send(WxQyCfg cfg, String body) {
        return WxQyApi.sendMsg(cfg, body);
    }
