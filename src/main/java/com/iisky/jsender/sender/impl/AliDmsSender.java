...
import com.iisky.jsender.sdk.aliyun.AliDmsApi;
 ...
 * @date 2021-09-01
 */
public class AliDmsSender implements ISender<AliYunCfg> {

    @Override
    public Resp send(AliYunCfg cfg, String body) {
        return AliDmsApi.sendMsg(cfg, body);
    }
