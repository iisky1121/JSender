...
import com.iisky.jsender.sdk.javamail.JavaMailApi;
 ...
 * @date 2021-09-01
 */
public class JavaMailSender implements ISender<JavaMailCfg> {

    @Override
    public Resp send(JavaMailCfg cfg, String body) {
        return JavaMailApi.sendMsg(cfg, body);
    }
