...
-- ----------------------------
INSERT INTO `api_template` (`id`, `config`, `remark`) VALUES ('demo', '{\"WxQySender\":{\"level\":1,\"template\":{\"agentid\":\"${cfg.agentId}\",\"touser\":\"${user.userId}\",\"textcard\":{\"description\":\"\\n机器编号：${deviceCode}\\n \\n机器名称：${deviceName}\\n \\n离线时间: ${time}\\n \\n\",\"title\":\"您的监控设备触发【${title}】规则\",\"url\":\"https://baidu.com?deviceCode=${deviceCode}\"},\"msgtype\":\"textcard\"}},\"DingTalkSender\":{\"level\":1,\"template\":{\"msgtype\":\"markdown\",\"markdown\":{\"title\":\"${title}\",\"text\":\"### ${title}\\n> - 机器编号：${deviceCode}\\n> - 机器名称：${deviceName}\\n> - 离线时间: ${time}\\n [[查看详情]](https://baidu.com)\"}}},\"JavaMailSender\":{\"level\":0,\"template\":{\"subject\":\"您的监控设备触发【${title}】规则\",\"recipient\":\"${user.email}\",\"content\":\"\\n机器编号：${deviceCode}\\n \\n机器名称：${deviceName}\\n \\n离线时间：${time}\\n \\n\"}}}', NULL);
